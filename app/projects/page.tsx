...
// images
import Intervyou1 from "@/public/images/projects.png";
import Intervyou2 from "@/public/images/projects.png";
import Intervyou3 from "@/public/images/projects.png";
				...
				<motion.div
					...
					{Object.keys(category).map((key, index) => (
						<button
							...
							{category[key as unknown as keyof typeof category]}
						</button>
					))}
				</motion.div>
				...
				<div className="w-screen mx-auto container gap-4 px-10 grid grid-cols-1 md:grid-cols-2 mb-10 cursor-pointer">
					{projects.map((project, index) => (
						<ProjectCard
							project={project}
							key={index}
							activeCategory={activeCategory} index={0}						/>
					))}
				</div>
