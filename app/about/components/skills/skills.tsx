		...
		<motion.div
			...
			<motion.div
				...
				<div className="flex flex-wrap justify-center gap-3">
					{selectedSkill.languages.map((lang: string, index: number) => (
						<motion.span
							key={lang}
			...
			<motion.div
				...
				<div className="flex flex-wrap justify-center gap-3">
					{selectedSkill.tools.map((tool: string, index: number) => (
						<motion.span
							key={tool}
							initial={{ opacity: 0, scale: 0.8 }}
							animate={{ opacity: 1, scale: 1 }}
...
export default function Skills() {
	const [selectedCategory, setSelectedCategory] = useState<SkillCategoryKey>("web");
	return (
