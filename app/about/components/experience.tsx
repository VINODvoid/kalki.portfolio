...
const experiences = [
	{
		...
		location: "Remote",
		description:
			"I developed and deployed machine learning models, including SM and Random Forest, using Python, scikit-learn, and pandas on Arch Linux systems, achieving a 15% improvement in prediction accuracy. I worked on preprocessing datasets and optimizing feature selection in Linux environments to enhance model performance for large-scale data retrieval. Additionally, I collaborated with the data science team to integrate models with REST APIs over TCP/IP, streamlining information retrieval processes. I also utilized TensorFlow for model experimentation and presented actionable insights to stakeholders, enabling data-driven project decisions.",
		skills: ["Python", "Matplotlib", "Seaborn", "TensorFlow", "Random Forest","Support Vector Machine (SVM)", "scikit-learn", "pandas", "Git", "Linux" ],
	},
	{
		id: 2,
		startDate: "Dec 2024",
		...
		description:
			"I developed responsive user interfaces with React.js and TypeScript, which improved user engagement by 20%. I built scalable REST APIs using Node.js and Express.js, deployed on AWS EC2 with Arch Linux, reducing response time by 30%. In an Agile environment, I integrated front-end and back-end components while optimizing PostgreSQL queries for scalability. Additionally, I configured development and deployment environments on Arch Linux, ensuring a robust and reliable distributed system architecture.",
		skills: ["JavaScript", "TypeScript", "React.js", "Node.js", "Express.js", "PostgreSQL", "Docker", "Git", "Agile Methodologies", "Linux"],
	},
