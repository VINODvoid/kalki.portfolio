...
import Me5 from "@/public/images/me.png";
import Me6 from "@/public/images/swordholding-berserk.png";
import Me4 from "@/public/images/guts.jpg";
...
export default function Education() {
  ...
  const achievementsByYear = {
    2025: [
      {
        icon: faMedal,
        title: "Competitor / Attendee",
        subtitle: "Solana Summit 2025",
        date: "Mar 2025",
    ...
    2024: [
      {
        ...
        subtitle: "Inter College Quiz Competition",
        date: "Aug 2024",
        color: "from-yellow-400 to-orange-500",
      },
      {
        icon: faMedal,
        title: "2nd place (Gold Medal)",
        subtitle: "Inter College Quiz Competition",
        date: "Jul 2024",
        color: "from-yellow-400 to-orange-500",
      },
  ...
  return (
    <Wrapper>
      <section className="grid gap-8 md:gap-12 text-gray-900">
        {" "}
        {/* Header */}
        <motion.div
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <p className="text-gray-600 text-justify title text-lg">
                  ...
                  currently  graduated my Bachelor&rsquo;s degree in{" "}
